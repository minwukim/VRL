...
#prompts, ground_truth, reward_kk = get_kk_test_prompts()
#
##print(reward_kk(prompts[0], ground_truth[0]))
#
#out_string = """
#Hello there </think><answer>
#(1) Minwu is a knave
#(2) Safal is a knight
#(3)</answer>
#"""
#
#ground_truth = "(1) Safal is a knight\n(2) Minwu is a knave"
#print(reward_kk(out_string, ground_truth))
