...
def generate_cot_prompt(val_df, curr, k):
    final_prompt = ""
    prompt = """The following are multiple choice questions (with answers) about {$}. Think step by step and then finish your answer with <answer> \\boxed{{X}} </answer> where X is the correct letter choice.
    """
    ...
    for example in val_df:
        example['question'] = prompt + example['question']
