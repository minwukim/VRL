...
# Need base Trainer class for explicit _prepare_inputs call
from transformers import Trainer
# Import necessary components from TRL
...
from trl.trainer.log import is_rich_available
if is_rich_available():
    from trl.trainer.log import print_prompt_completions_sample
try:
    import wandb
except ImportError:
    wandb = None
    ...
    def _generate_and_score_completions(
        ...
        if self.log_completions and self.state.global_step % self.args.logging_steps == 0:
             ...
             if self.accelerator.is_main_process:
                 ...
                 num_to_log = min(5, len(all_prompts_text))
